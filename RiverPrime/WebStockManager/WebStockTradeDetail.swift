...
//
//
//class WebSocketDetail: WebSocketDelegate {
...
//        if let jsonData = try? JSONSerialization.data(withJSONObject: message, options: []),
//           let jsonString = String(data: jsonData, encoding: .utf8) {
//            print("Sending history message: \(jsonString)")
//            webSocket.write(string: jsonString)
//        }
//    }
//    
...
//        switch event {
//        case .connected:
//            print("WebSocket history Detail connected")
//        case .text(let string):
//            handleHistoryWebSocketMessage(string)
//        case .disconnected(let reason, let code):
//            print("WebSocketDetail disconnected: \(reason) with code: \(code)")
//        case .error(let error):
//            handleHistoryError(error)
//        default:
//            break
