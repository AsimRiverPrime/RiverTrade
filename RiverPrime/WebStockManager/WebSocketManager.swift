...
//
//        // Determine the socket timer based on the count
//        switch GlobalVariable.instance.socketTimerCount {
//        case 1...4:
//            GlobalVariable.instance.socketTimer = 20.0
//        case 5...9:
//            GlobalVariable.instance.socketTimer = 30.0
//        case 10...14:
//            GlobalVariable.instance.socketTimer = 40.0
//        case 15...19:
//            GlobalVariable.instance.socketTimer = 50.0
//        case 20...:
//            GlobalVariable.instance.socketTimer = 60.0
//        default:
//            GlobalVariable.instance.socketTimer = 10.0 // Fallback (if needed)
//        }
//
////        if GlobalVariable.instance.socketTimerCount > 0 && GlobalVariable.instance.socketTimerCount < 5 {
////            GlobalVariable.instance.socketTimer = 20.0
////        } else if GlobalVariable.instance.socketTimerCount > 5 && GlobalVariable.instance.socketTimerCount < 10 {
////            GlobalVariable.instance.socketTimer = 30.0
////        } else if GlobalVariable.instance.socketTimerCount > 10 && GlobalVariable.instance.socketTimerCount < 15 {
////            GlobalVariable.instance.socketTimer = 40.0
////        } else if GlobalVariable.instance.socketTimerCount > 15 && GlobalVariable.instance.socketTimerCount < 20 {
////            GlobalVariable.instance.socketTimer = 50.0
////        } else if GlobalVariable.instance.socketTimerCount >= 20 {
////            GlobalVariable.instance.socketTimer = 60.0
////        }
//////        GlobalVariable.instance.socketTimer = 60.0
